...
public class LiquidParser
{
    ...
    /// <summary>
    /// Sets content using an object. Data will be available using the 'content' variable and the serialized object as
    /// JSON.
    /// </summary>
    ...
    /// <returns>The current instance to use for method chaining.</returns>
    private LiquidParser SetContentXml(XmlDocument document)
    {
        return SetContentJson(JsonConvert.SerializeXmlNode(document));
    }
